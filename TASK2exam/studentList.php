...
<header class="header" id="header">
  <div class="header_toggle"> <i class='bx bx-menu' id="header-toggle"></i> </div>
    <p style="font-size: 30px; margin-top: 12px;">Student List</p>
...
<body class="index g-sidenav-show  bg-gray-200">
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div>
              <a href='index.php' class='nav_logo'> <i class='bx bx-layer nav_logo-icon'></i> <span class='nav_logo-name'>GibJohn Tutoring</span> </a>
                <div class='nav_list'>
                  ...
                  <!-- Student List -->
                  <a href='studentList.php' class='nav_link active'>
    ...
    <?php
        ...
        // SQL Get all users
        $sql = "SELECT * FROM studentsexamt2";  // Select everything from the database table named 'adminsexamt2'
