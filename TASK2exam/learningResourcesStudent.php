...
<header class="header" id="header">
  <div class="header_toggle"> <i class='bx bx-menu' id="header-toggle"></i> </div>
    <p style="font-size: 30px; margin-top: 12px;">Learning Resources</p>
...
<body class="index g-sidenav-show  bg-gray-200">
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div>
              <a href='indexStudent.php' class='nav_logo'> <i class='bx bx-layer nav_logo-icon'></i> <span class='nav_logo-name'>GibJohn Tutoring</span> </a>
                <div class='nav_list'>
                  ...
                  <!-- Learning Resources -->
                  <a href='learningResourcesStudent.php' class='nav_link active'> <i class='bx bx-book-reader nav_icon'></i> <span class='nav_name'>Learning Resources</span> </a>
    ...
    <?php
        ...
        // SQL Get all users
        $sql = "SELECT * FROM resourcesexamt2";  // Select everything from the database table named 'adminsexamt2'
          ...
          <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
            <thead>
              <tr>
                ...
                <th class="th-sm">Date of Upload</th>
                <th class="th-sm">Subject</th>
                <th class="th-sm">Type of Resource</th>
                <th class="th-sm">Resource Link</th>
              </tr>
            </thead>
            <tbody>
            ...
            <tr>
               ...
               <td><?php echo htmlspecialchars($row['dateOfUpload']); ?></td>
               <td><?php echo htmlspecialchars($row['subject']); ?></td>
               <td><?php echo htmlspecialchars($row['typeOfResource']); ?></td>
               <td><?php echo htmlspecialchars($row['resourceLink']); ?></td>
            </tr>
            <?php endwhile; ?>
           </tbody>
          </table>
