              ...
              <div class="col-lg-4 col-md-6">
                <div class="category-item">
                  <div class="ci-text">
                    ...
                    <!-- This button will be used to mark the wider learning as complete which will give them 10 xp -->
                    <a>
                      <button class="btn btn-info btn-block my-4" style="background-color: darkgreen; border-color: darkgreen;">Completed</button>
                    </a>
                    <!-- --- -->
